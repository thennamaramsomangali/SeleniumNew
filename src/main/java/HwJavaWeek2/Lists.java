package HwJavaWeek2;
		...
		public class Lists {
			...
			public static void main(String[] args) {
				...
				// contains
				System.out.println("Is Gopi is available " + "in the set :"+mentors.contains("Gopi"));

				// remove
				mentors.remove("Gopi");

				// contains
				System.out.println("Is Gopi is available in the List"	+ " after removal :"+mentors.contains("Gopi"));
				...
				// check if it empty
				System.out.println("The List is empty :"+ ""+mentors.isEmpty());
