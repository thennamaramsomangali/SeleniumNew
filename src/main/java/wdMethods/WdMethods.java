...
public interface WdMethods {
		...
		/* This method will close or escape screen appears inside the window.*/
	     public void escapeWindow();
	   
	     /*This method will do mouse over on the selected web element*/
	     
	     public void mouseHover();
	     
	     /*This method will do click on the web element
	      * 
	      */
